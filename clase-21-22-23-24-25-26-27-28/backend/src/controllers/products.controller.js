...
export const createProductController = async (req, res, next) => {
    try {
        ...
        const required = ["title", "price", "stock", "description", "category", "seller_id"]
        ...
        if (missing_fields) {
            return next(new AppError('Faltan valores para crear el producto', 400, {}, 'MISSING_FIELDS'))
        }
        ...
        const productConfig = new FieldConfig()
            ...
            .setNewField('seller_id', seller_id)
            .setFieldValidations('seller_id', [verifyNumber])
            .validateFields()
            .build()
